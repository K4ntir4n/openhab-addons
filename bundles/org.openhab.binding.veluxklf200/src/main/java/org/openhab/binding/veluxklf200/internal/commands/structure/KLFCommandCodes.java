...
public class KLFCommandCodes {
    ...
    /** Set node name. */
    public static final short GW_SET_NODE_NAME_REQ = (short) 0x0208;

    /** Acknowledge to GW_SET_NODE_NAME_REQ. */
    public static final short GW_SET_NODE_NAME_CFM = (short) 0x0209;

    /** Set node velocity. */
    public static final short GW_SET_NODE_VELOCITY_REQ = (short) 0x020A;

    /** Acknowledge to GW_SET_NODE_VELOCITY_REQ. */
    public static final short GW_SET_NODE_VELOCITY_CFM = (short) 0x020B;

    /** Send Activate Mode to one or more io-homecontrol® nodes. */
    public static final short GW_MODE_SEND_REQ = (short) 0x0320;

    /** Acknowledge to GW_MODE_SEND_REQ. */
    public static final short GW_MODE_SEND_CFM = (short) 0x0321;

    /** Notify with Mode activation info. */
    public static final short GW_MODE_SEND_NTF = (short) 0x0322;
    ...
    /** */
    public static final short GW_NODE_INFORMATION_CHANGED_NTF = (short) 0x020C;
}
