...
public enum KLFCommandStructure {
    ...
    /** Send a mode command to a Velux node. */
    SEND_NODE_MODE_COMMAND(
            "Send a mode command to a specific node on the KLF200 device.",
            "GW_MODE_SEND_REQ",
            KLFCommandCodes.GW_MODE_SEND_REQ,
            new short[] {
                KLFCommandCodes.GW_MODE_SEND_CFM,
                KLFCommandCodes.GW_COMMAND_RUN_STATUS_NTF,
                KLFCommandCodes.GW_COMMAND_REMAINING_TIME_NTF,
                KLFCommandCodes.GW_SESSION_FINISHED_NTF
                },
    ...
    SET_NODE_NAME(
            ...
            KLFCommandCodes.GW_SET_NODE_NAME_REQ,
            new short[] {
                KLFCommandCodes.GW_SET_NODE_NAME_CFM
            },
            KLFCommandStructure.MASK_AUTH_REQD | KLFCommandStructure.MASK_NODE_SPECIFIC
            ),
    ...
    /** Set Node Velocity */
    SET_NODE_VELOCITY(
            "Sets the velocity of a node.",
            "GW_SET_NODE_VELOCITY_REQ",
            KLFCommandCodes.GW_SET_NODE_VELOCITY_REQ,
            new short[] {
                KLFCommandCodes.GW_SET_NODE_VELOCITY_CFM
            },
            KLFCommandStructure.MASK_AUTH_REQD | KLFCommandStructure.MASK_NODE_SPECIFIC
            ),
